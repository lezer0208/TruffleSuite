...
#[derive(Debug)]
pub struct TruffleSuiteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TruffleSuiteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TruffleSuite processing");
    
    let mut processor = TruffleSuiteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TruffleSuiteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TruffleSuiteProcessor::new(false);
